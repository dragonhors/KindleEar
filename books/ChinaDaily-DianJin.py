...
# 继承基类BaseFeedBook
class ChinaDaily2(BaseFeedBook):
    # 设定生成电子书的元数据
    title = u'英语点津' # 设定标题
    __author__ = u'China Daily' # 设定作者
    description = u'language.chinadaily.com.cn 英语点津，英语学习好地方' # 设定简介
    language = 'en' # 设定语言
    ...
    feeds = [
        (u'双语', 'https://language.chinadaily.com.cn/news_bilingual/'),
    ...
    def ParsePageContent(self, topic, url, urls, count):
        ...
        if result.status_code == 200 and result.content:
            ...
            next = soup.find(name='a',class_='pagestyle', string='Next')
